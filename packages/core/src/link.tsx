...
/**
 * Augment this interface via declaration merging in .elyra/routes.d.ts
 * to get type-safe `to` autocompletion and per-route `search` types on <Link>.
 *
 * @example
 * // .elyra/routes.d.ts (auto-generated by Elyra)
 * import "elyra/link";
 ...
 * }
 */
// biome-ignore lint/suspicious/noEmptyInterface: intentionally augmentable via .elyra/routes.d.ts
